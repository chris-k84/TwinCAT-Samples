...
class CCppDevProjectCtrl : public ITcOCFCtrlImpl<CCppDevProjectCtrl, CCppDevProjectClassFactory>
{
public:
	CCppDevProjectCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("CppDevProject: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CCppDevProjectCtrl>;
